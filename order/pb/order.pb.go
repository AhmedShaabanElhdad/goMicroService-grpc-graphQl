...
type Order struct {
	...
	CreatedAt []byte                `protobuf:"bytes,4,opt,name=createdAt,proto3" json:"createdAt,omitempty"`
...
func (x *GetAccountOrdersRequest) Reset() {
	*x = GetAccountOrdersRequest{}
	mi := &file_pb_order_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetAccountOrdersRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAccountOrdersRequest) ProtoMessage() {}

func (x *GetAccountOrdersRequest) ProtoReflect() protoreflect.Message {
	mi := &file_pb_order_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAccountOrdersRequest.ProtoReflect.Descriptor instead.
func (*GetAccountOrdersRequest) Descriptor() ([]byte, []int) {
	return file_pb_order_proto_rawDescGZIP(), []int{5}
}

func (x *GetAccountOrdersRequest) GetAccountId() string {
	if x != nil {
		return x.AccountId
	}
	return ""
...
func (x *GetAccountOrdersResponse) Reset() {
	*x = GetAccountOrdersResponse{}
	mi := &file_pb_order_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetAccountOrdersResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAccountOrdersResponse) ProtoMessage() {}

func (x *GetAccountOrdersResponse) ProtoReflect() protoreflect.Message {
	mi := &file_pb_order_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAccountOrdersResponse.ProtoReflect.Descriptor instead.
func (*GetAccountOrdersResponse) Descriptor() ([]byte, []int) {
	return file_pb_order_proto_rawDescGZIP(), []int{6}
}

func (x *GetAccountOrdersResponse) GetOrders() []*Order {
	if x != nil {
		return x.Orders
	}
	return nil
...
var file_pb_order_proto_rawDesc = []byte{
	...
	0x12, 0x02, 0x70, 0x62, 0x22, 0xa6, 0x02, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x0e,
	...
	0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74,
	0x12, 0x32, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x18, 0x05, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x16, 0x2e, 0x70, 0x62, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x4f, 0x72,
	...
	0x01, 0x28, 0x0d, 0x52, 0x08, 0x71, 0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x22, 0xb9, 0x01,
	...
	0x08, 0x71, 0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x22, 0x34, 0x0a, 0x11, 0x50, 0x6f, 0x73,
	...
	0x52, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x22, 0x37, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x41, 0x63,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64,
	0x22, 0x3d, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x4f, 0x72,
	...
	0x47, 0x65, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x12, 0x13, 0x2e, 0x70, 0x62, 0x2e,
	...
	,
...
var file_pb_order_proto_goTypes = []any{
	...
	(*GetAccountOrdersRequest)(nil),       // 5: pb.GetAccountOrdersRequest
	(*GetAccountOrdersResponse)(nil),      // 6: pb.GetAccountOrdersResponse
...
var file_pb_order_proto_depIdxs = []int32{
	...
	0, // 4: pb.GetAccountOrdersResponse.orders:type_name -> pb.Order
	1, // 5: pb.OrderService.PostOrder:input_type -> pb.PostOrderRequest
	3, // 6: pb.OrderService.GetOrderId:input_type -> pb.GetOrderRequest
	5, // 7: pb.OrderService.GetAccountOrders:input_type -> pb.GetAccountOrdersRequest
	2, // 8: pb.OrderService.PostOrder:output_type -> pb.PostOrderResponse
	4, // 9: pb.OrderService.GetOrderId:output_type -> pb.GetOrderResponse
	6, // 10: pb.OrderService.GetAccountOrders:output_type -> pb.GetAccountOrdersResponse
